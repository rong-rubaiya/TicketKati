...
import { FiMail, FiUser, FiPhone, FiBriefcase } from "react-icons/fi";
...
const AdminProfile = () => {
  ...
  return (
    <div className="ml-0 sm:ml-20 my-10 p-6 bg-white dark:bg-[#0f0f2a] rounded-2xl shadow-md dark:border-gray-700 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <InfoCard icon={<FiMail />} label="Email" value={user.email || "admin@example.com"} />
        <InfoCard icon={<FiPhone />} label="Phone" value={user.phone || "N/A"} />
        <InfoCard icon={<FiUser />} label="Username" value={user.username || "admin"} />
        <InfoCard icon={<FiBriefcase />} label="Position" value="Administrator" />
      </div>
    </div>
  );
};
